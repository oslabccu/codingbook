...
char* docker_password = " -e PASSWORD=";
char* docker_PUID = " -e PUID=";
char* docker_PGID = " -e PGID=";
char* docker_system_limit = " --cpus=1 --cpuset-cpus=\"1-23\" ";
char* docker_ip = " -P ";
char* docker_external_folder = " -v /home/ccugrp/";
char* docker_internal_folder = ":/config ";
char* docker_image_version = " sp:0.4 ";
...
//get contianer IP
char* docker_get_container_IP = "docker ps --filter \"name=\" --format \"{{.Ports}}\" | awk -F ':' '{print $2}' | awk -F '-' '{print $1}'";


char* host_ip = "140.123.97.31";
char* PGID;
char* Successed = "10";
char* Failed = "11";
